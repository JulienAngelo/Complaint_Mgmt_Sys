                ...
                <div className="navbar-nav">
                    ...
                    <li className="nav-item dropdown nav-item-pad">
                        ...
                        <div className="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                            ...
                            <Link to={"/"} className="dropdown-item d-item" >Conference</Link>
                            <div className="dropdown-divider"></div>
                            <Link to={"/"} className="dropdown-item d-item" >Research</Link>
                            <div className="dropdown-divider"></div>
                            <Link to={"/"} className="dropdown-item d-item" >Workshop</Link>
                        </div>
                    </li>
                    <li className="nav-item dropdown nav-item-pad">
                        <a className="nav-link dropdown-toggle" id="navbarDropdown" role="button"
